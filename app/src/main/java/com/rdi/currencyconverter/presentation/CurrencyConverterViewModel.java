...
import com.rdi.currencyconverter.domain.LoadCurrenciesException;
import com.rdi.currencyconverter.domain.SingleLiveEvent;
import com.rdi.currencyconverter.domain.model.Currency;
import com.rdi.currencyconverter.presentation.utils.IResourceWrapper;
...
class CurrencyConverterViewModel extends ViewModel {
    ...
    private final MutableLiveData<List<String>> mCurrenciesLable = new MutableLiveData<>();
    ...
    void loadCurrencies() {
        ...
        mExecutor.execute(() -> {
            try {
                ...
                List<String> currenciesLable = new ArrayList<>();
                for (Currency currency :
                        currencies) {
                    currenciesLable.add(currency.getName());
                }
                mCurrenciesLable.postValue(currenciesLable);
     ...
     */
    @NonNull
    LiveData<List<String>> getCurrenciesLable() {
        return mCurrenciesLable;
    }
